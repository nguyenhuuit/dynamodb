...
var _            = require('lodash'),
    ...
    { CreateTableCommand, DeleteTableCommand } = require('@aws-sdk/client-dynamodb'),
...
Table.prototype.createTable = function (options, callback) {
  ...
  self.dynamoClient.send(new CreateTableCommand(params)).then(data => callback(null, data));
};
...
Table.prototype.deleteTable = function (callback) {
  ...
  self.dynamoClient.send(new DeleteTableCommand(params)).then(data => callback(null, data));
